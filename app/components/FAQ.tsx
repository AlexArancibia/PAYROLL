...
const faqs: FAQItem[] = [
  {
    ...
    answer: 'Payroll Plus es una plataforma integral de gestión de nómina que ofrece soluciones personalizadas y confiables para empresas de todos los tamaños...',
  },
  {
    question: '¿Cuáles son las ventajas de que Payroll Plus procese la nómina por mí?',
    answer: 'Nuestras soluciones de nómina no solo ahorran tiempo y alivian la carga de trabajo, sino que también combinan tecnología avanzada...',
  },
  {
    question: '¿A qué empresas ofrecemos nuestros servicios?',
    answer: 'Brindamos servicios de nómina para empresas de todos los tamaños, nacionales e internacionales...',
  },
  {
    question: '¿Payroll Plus proporciona herramientas en línea para que los empleados gestionen su nómina y recursos humanos?',
    answer: 'Nuestras soluciones permiten a los empleados acceder desde cualquier dispositivo para ver recibos...',
  },
];
